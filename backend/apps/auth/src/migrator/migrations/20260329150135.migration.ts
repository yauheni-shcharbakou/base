...
export class Migration20260329150135 extends Migration {
  override async up(): Promise<void> {
    this.addSql(
      `create table "temp-codes" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "user_id" varchar(255) not null, "code" varchar(255) not null, "is_active" boolean not null, "expired_at" timestamptz not null, constraint "temp-codes_pkey" primary key ("id"));`,
    );
