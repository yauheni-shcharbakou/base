...
export class Migration20260329150952 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "images" ("id" varchar(255) not null, "created_at" timestamptz not null, "updated_at" timestamptz not null, "user_id" varchar(255) not null, "file_id" varchar(255) not null, "width" int not null, "height" int not null, "alt" varchar(255) not null, "upload_id" varchar(255) not null, constraint "images_pkey" primary key ("id"));`);
