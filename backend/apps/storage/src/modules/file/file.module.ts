import { NatsModule, NatsStorageFileTransport } from '@backend/nats';
import { PgModule } from '@backend/pg';
import { StorageObjectModule } from '@modules/storage-object-old/storage-object.module';
...
@Module({
  imports: [
    PgModule.forFeature(PgFileEntity),
    NatsModule.forFeature({ EventBus: NatsStorageFileTransport.EventBus }),
    StorageModule,
    StorageObjectModule,
  ],
  providers: [
  ...
  controllers: [GrpcFileController],
