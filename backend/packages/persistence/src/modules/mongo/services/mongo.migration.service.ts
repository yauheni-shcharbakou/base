...
// import { MongoMigrationEntity } from 'modules/mongo/entities';
// import { MongoMigrationStatus } from 'modules/mongo/enums';
// import { MONGO_TASKS } from 'modules/mongo/mongo.constants';
// import { Model } from 'mongoose';
//
// @Injectable()
// export class MongoMigrationService implements OnModuleInit {
//   readonly logger: Logger = new Logger(MongoMigrationService.name);
//
//   constructor(
